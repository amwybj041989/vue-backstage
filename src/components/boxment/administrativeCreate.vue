        ...
        <el-col :span="24" class="el-item editor-form display-table">
            <div class="form-left">
                <el-form ref="form" :rules="rules" label-position="right" :model="form" label-width="150px">
                    <el-form-item label="隶属省份" prop="parentId1" v-if="type === 'c' || type === 'a'">
                    ...
                    <el-form-item label="隶属城市" prop="parentId2" v-if="type === 'a'">
                        <el-select v-model="form.parentId2" placeholder="请选择" no-data-text="请先选择省份/没有数据">
