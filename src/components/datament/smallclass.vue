        ...
        <el-col :span="24" class="el-item display-table top-toolbar-complex">
            ...
            <div class="toolbar-function tr">
                <el-form :model="toolbarFrom" :inline="true" class="tr">
                    <el-form-item>
                        <el-button type="primary" @click="routerPushNew()">新增小类</el-button>
                    </el-form-item>
                    <el-form-item>
    ...
    <el-row class="mb-15">
        <el-col :span="24" class="el-item pa-10">
            <el-table :data="productClassList.list" :stripe="true" class="w-100" :row-class-name="tableRowDisabled">
                ...
                <el-table-column prop="mediumclass" label="二级类目" width="130"></el-table-column>
                <el-table-column prop="smallclass" label="三级类目"></el-table-column>
...
export default {
    ...
    computed: {
        productClassList() { return this.$store.getters.smallclassdata }
    },
    methods: {
        routerPush(id) {
