...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config_config__ = __webpack_require__(108);
...
/* harmony export (immutable) */ __webpack_exports__["q"] = ELMENU_SWITCH;

const HEADERNAV_SWITCH = 'HEADERNAV_SWITCH';
/* harmony export (immutable) */ __webpack_exports__["p"] = HEADERNAV_SWITCH;
...
/* harmony export (immutable) */ __webpack_exports__["o"] = GET_OVERVIEW_DATA_SUCCESS;


// 销售管理
const GET_DASHBOARD_DATA_SUCCESS = 'GET_DASHBOARD_DATA_SUCCESS';
/* harmony export (immutable) */ __webpack_exports__["n"] = GET_DASHBOARD_DATA_SUCCESS;

const GET_ORDERLIST_SUCCESS = 'GET_ORDERLIST_SUCCESS';
/* harmony export (immutable) */ __webpack_exports__["m"] = GET_ORDERLIST_SUCCESS;
...
/* harmony export (immutable) */ __webpack_exports__["j"] = GET_USERBASIS_DATA_SUCCESS;

const GET_USERBUYRECORD_SUCCESS = 'GET_USERBUYRECORD_SUCCESS';
/* harmony export (immutable) */ __webpack_exports__["k"] = GET_USERBUYRECORD_SUCCESS;


// 员工管理
const GET_STAFFTALIST_SUCCESS = 'GET_STAFFTALIST_SUCCESS';
/* harmony export (immutable) */ __webpack_exports__["i"] = GET_STAFFTALIST_SUCCESS;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__modules_userlist__ = __webpack_require__(273);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__modules_userdata__ = __webpack_require__(272);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__modules_boxment__ = __webpack_require__(263);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__modules_staffment__ = __webpack_require__(271);
...
const store = new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
    modules: {
        ...
        boxment: __WEBPACK_IMPORTED_MODULE_8__modules_boxment__["a" /* default */],
        staffment: __WEBPACK_IMPORTED_MODULE_9__modules_staffment__["a" /* default */],
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_api_js__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_api_js__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_topbar_vue__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_topbar_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__common_topbar_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__static_style_datament_supplierEdior_scss__ = __webpack_require__(526);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__static_style_datament_supplierList_scss__ = __webpack_require__(527);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_echarts__ = __webpack_require__(109);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__static_style_common_echarts_scss__ = __webpack_require__(154);
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_api_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_config_js__ = __webpack_require__(108);
...
const actions = {
    ...
    headernavSwitch({ commit }) {
        ...
        commit(__WEBPACK_IMPORTED_MODULE_0__mutation__["p" /* HEADERNAV_SWITCH */], { data });
    },
    /**
     * 切换左侧菜单
     */
    elmenuSwitch({ commit }, type) {
        ...
        commit(__WEBPACK_IMPORTED_MODULE_0__mutation__["q" /* ELMENU_SWITCH */], { data });
    }
};

const mutations = {
    [__WEBPACK_IMPORTED_MODULE_0__mutation__["p" /* HEADERNAV_SWITCH */]](state, {
        data
    }) {
        state.headernav = data;
    },
    [__WEBPACK_IMPORTED_MODULE_0__mutation__["q" /* ELMENU_SWITCH */]](state, {
        data
    }) {
        state.elmenu = data;
    }
...
const actions = {
    ...
    getOrderList({ commit }, param) {
        __WEBPACK_IMPORTED_MODULE_0__api_api__["a" /* default */].getOrderList(param, function (response) {
            commit(__WEBPACK_IMPORTED_MODULE_1__mutation__["m" /* GET_ORDERLIST_SUCCESS */], { response });
        });
    }
};

const mutations = {
    [__WEBPACK_IMPORTED_MODULE_1__mutation__["m" /* GET_ORDERLIST_SUCCESS */]](state, { response }) {
        let _data = {};
    ...
    * */
    getOverviewData({ commit }) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__api_api__["a" /* default */].getOverviewData(function (response) {
            ...
            // 获取成功，提交mutations处理数据
            commit(__WEBPACK_IMPORTED_MODULE_1__mutation__["o" /* GET_OVERVIEW_DATA_SUCCESS */], { response });
            // loading 结束
...
const mutations = {
    [__WEBPACK_IMPORTED_MODULE_1__mutation__["o" /* GET_OVERVIEW_DATA_SUCCESS */]](state, { response }) {
    ...
    * */
    getDashboardData({ commit }) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__api_api__["a" /* default */].getDashboardData(function (response) {
            // console.log(response);
            // 获取成功，提交mutations处理数据
            commit(__WEBPACK_IMPORTED_MODULE_1__mutation__["n" /* GET_DASHBOARD_DATA_SUCCESS */], { response });
            // loading 结束
            // commit(types.COMM_LOADING_STATUS,false)
        });
    }
...
const mutations = {
    [__WEBPACK_IMPORTED_MODULE_1__mutation__["n" /* GET_DASHBOARD_DATA_SUCCESS */]](state, { response }) {
        let _data = response.data.data;
...
const actions = {
    ...
    getStafftalist({ commit }, param) {
        __WEBPACK_IMPORTED_MODULE_0__api_api__["a" /* default */].getStafftalist(param, function (response) {
            commit(__WEBPACK_IMPORTED_MODULE_1__mutation__["i" /* GET_STAFFTALIST_SUCCESS */], { response });
        });
    }
...
const mutations = {
    [__WEBPACK_IMPORTED_MODULE_1__mutation__["i" /* GET_STAFFTALIST_SUCCESS */]](state, { response }) {
        console.log('dddd');
...
const actions = {
    ...
    getUserBasisData({ commit }, param) {
        __WEBPACK_IMPORTED_MODULE_0__api_api__["a" /* default */].getUserBasisData(param, function (response) {
            commit(__WEBPACK_IMPORTED_MODULE_1__mutation__["j" /* GET_USERBASIS_DATA_SUCCESS */], { response });
        });
    },
    /**
     * 获取注册用户购买记录
    ...
    getUserBuyRecord({ commit }, param) {
        __WEBPACK_IMPORTED_MODULE_0__api_api__["a" /* default */].getUserBuyRecord(param, function (response) {
            commit(__WEBPACK_IMPORTED_MODULE_1__mutation__["k" /* GET_USERBUYRECORD_SUCCESS */], { response });
        });
    }
};

const mutations = {
    [__WEBPACK_IMPORTED_MODULE_1__mutation__["j" /* GET_USERBASIS_DATA_SUCCESS */]](state, { response }) {
        state.userBasisData = response.data.data;
    },
    [__WEBPACK_IMPORTED_MODULE_1__mutation__["k" /* GET_USERBUYRECORD_SUCCESS */]](state, { response }) {
        let _data = response.data.data;
        _data.count = Number(_data.count);
        console.log(_data);
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__router_router__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store_store__ = __webpack_require__(176);
...
//# sourceMappingURL=app.6a20b7b4ad0f5c1ece14.js.map